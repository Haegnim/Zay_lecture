            ...
            <div class="item_frame">
              ...
              <div class="like_unlike">
                <div class="like_icons">
                  ...
                  <span id="like_<?=$pro_row_idx?>" class="like" style="<?php if($like_unlike_type == 1){echo "background: #59ab6e;
        color: #fff;";} ?>">좋아요 | <b id="likes_<?=$pro_row_idx?>"><?=$total_likes?></b></span>
                  <span id="unlike_<?=$pro_row_idx?>" class="unlike" style="<?php if($like_unlike_type == 0){echo "background: lightcoral;
        color: #fff;";} ?>">별로에요 | <b id="unlikes_<?=$pro_row_idx?>"><?=$total_unlikes?></b></span>
                  <?php } ?>
