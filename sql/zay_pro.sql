...
CREATE TABLE `zay_pro` (
  ...
  `ZAY_pro_besc` text CHARACTER SET utf8 NOT NULL COMMENT '상품설명',
  `ZAY_pro_color` varchar(30) CHARACTER SET utf8 NOT NULL COMMENT '상품색상',
  `ZAY_pro_img_01` varchar(30) CHARACTER SET utf8 NOT NULL COMMENT '상품사진1',
  `ZAY_pro_img_02` varchar(30) CHARACTER SET utf8 NOT NULL COMMENT '상품사진2',
  `ZAY_pro_reg` varchar(30) CHARACTER SET utf8 NOT NULL COMMENT '등록일'
