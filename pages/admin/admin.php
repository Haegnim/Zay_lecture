...
<body>
    ...
    ">
      <div class="center">
        ...
        <div class="admin_tabs">
          <button type="button">상품입력</button>
        ...
        <div class="admin_panels">
          ...
          <div class="mem_admin">
            <ul class="mem_admin_lists">
              ...
              <form action="#" class="mem_admin_form" id="mem_admin_form" method="post">
                <?php
  ...
  $(function() {
    $(".update_btn").click(function() {
      ...
      //`/zay/php/member_update.php?update_idx=3%mem_level=5`;
      location.href = `/zay/php/member_update.php?update_idx=${mem_idx}&mem_level=${mem_level}`;
      // $("#mem_admin_form").attr('action',
      //   `/zay/php/member_update.php?update_idx=${mem_idx}&mem_level=${mem_level}`).submit();
    });
    // console.log(mem_idx);
    $(".select_del_btn button").click(function() {
      ...
      $("#mem_admin_form").attr('action',
        `/zay/php/admin_delete.php`).submit();
